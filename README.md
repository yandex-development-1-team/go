...
- **Go 1.26+** — на компе нужна актуальная версия. Проверка: `go version`. Установка: [go.dev/dl](https://go.dev/dl/). Для автоматической подстановки тулчейна: в `go.env` или окружении задать `GOTOOLCHAIN=auto`.
