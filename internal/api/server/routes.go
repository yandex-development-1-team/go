...
func SetupRoutes(router *gin.Engine, boxHandler *handlers.BoxHandler, settingsHandler *handlers.SettingsHandler) {
	// API v1 group
...
func setupSettingsRoutes(rg *gin.RouterGroup, settingsHandler *handlers.SettingsHandler) {
	...
	{
		// GET /api/v1/settings - получение настроек для админки
