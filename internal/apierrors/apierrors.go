...
var errMappings = []errMapping{
	...
	{models.ErrRefreshTokenNotFound, http.StatusUnauthorized, "токен не найден или недействителен"},
	{models.ErrRefreshTokenExpired, http.StatusUnauthorized, "токен истёк"},
	{models.ErrRefreshTokenRevoked, http.StatusUnauthorized, "токен отозван"},
